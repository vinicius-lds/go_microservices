...
type RoundTripeFunc func(req *http.Request) *http.Response

func (f RoundTripeFunc) RoundTrip(req *http.Request) (*http.Response, error) {
	return f(req), nil
}

func NewTestClient(fn RoundTripeFunc) *http.Client {
	return &http.Client{
		Transport: fn,
	}
}
